...
[docs]def read_table(name: str, index_col: Optional[Union[str, List[str]]] = None) -> DataFrame:
    """
...
[docs]def read_clipboard(sep: str = r"\s+", **kwargs: Any) -> DataFrame:
    r"""
...
[docs]def broadcast(obj: DataFrame) -> DataFrame:
    """
